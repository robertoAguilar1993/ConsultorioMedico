...
public class vtnsintomas_diagnostico extends javax.swing.JFrame {

      //la fecha
        Date date = new Date();
        DateFormat fecha = new SimpleDateFormat("yyyy-MM-dd");
        
    public vtnsintomas_diagnostico() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 102), 3, true), "Tratamiento", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Traditional Arabic", 1, 18))); // NOI18N

        txatratamientos.setBackground(new java.awt.Color(244, 244, 244));
        txatratamientos.setColumns(20);
        txatratamientos.setRows(5);
        jScrollPane2.setViewportView(txatratamientos);
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        mod.setId2(Integer.parseInt(txtid.getText()));
        mod.setDignostico(txadiagnostico.getText());
        mod.setTratamiento(txatratamientos.getText());
        mod.setFecha(fecha.format(date));

        if(modsql.registar_diagnostico(mod)){
            JOptionPane.showMessageDialog(null,"dignostico registrado");
        }
        else{
            JOptionPane.showMessageDialog(null,"no se registro el dignostico");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vtnsintomas_diagnostico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vtnsintomas_diagnostico().setVisible(true);
            }
        });
    }
